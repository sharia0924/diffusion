...
- 载密图基线: PSNR 9.39 dB / SSIM 0.0969 / LPIPS n/a
- nonce 协议: `nonce_i = H(key || nonce_start+i)`（自包含, 不依赖 cover）

## A. 错密钥/近密钥 BER 分布

- 错密钥数 156（随机 100 + 近密钥变体）
- BER: mean **0.4944** / std 0.0232 / min 0.4395 / max 0.5605（期望 0.5，越集中越安全）
...
- 错密钥距离: mean 15.90 / std 0.50（期望 ≈ 16.0）
- FAR@tau=4: **0.00000**
- FAR@tau=8: **0.00000**
- FAR@tau=12: **0.00000**
...
- 无 nonce 协议: mean **0.192** / max 0.479
- 逐图 nonce（ours）: mean **0.033** / max 0.150
